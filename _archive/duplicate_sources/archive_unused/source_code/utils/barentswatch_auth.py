...
class BarentsWatchAuth:
    ...
    def __init__(self):
        ...
        self.base_url = "https://historic.ais.barentswatch.no/v1/historic/"
    ...
    def test_connection(self) -> bool:
        ...
        try:
            ...
            # Test API endpoint - use a simple endpoint without complex parameters
            test_url = f"{self.base_url}trackslast24hours/257123456"  # Test with a sample MMSI
